...
let PhotoPlistComponent = class PhotoPlistComponent {
    constructor(photoService, router) {
        this.photoService = photoService;
        this.router = router;
        this.photos = [];
...
PhotoPlistComponent.ctorParameters = () => [
    { type: _services_photo_service__WEBPACK_IMPORTED_MODULE_3__["PhotoService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
let PhotoPreviewComponent = class PhotoPreviewComponent {
    constructor(activeRouter, router, photoService) {
...
let PhotoService = class PhotoService {
    ...
    createPhoto(title, description, photo) {
